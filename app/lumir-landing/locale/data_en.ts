...
export const DATA_EN = {
    ...
    sections: {
      ...
      heroCard: {
        intro: "The only NFT that delivers both real utility and transparent capital protection.",
        items: [
          "Minimum 90% protection after 90 days (terms apply).",
          "Team Access for 10 members — 13W Challenge.",
          "24/7 AI Coaching & Trader Behavioral Index.",
        ],
      },
      compare: {
      ...
      benefits: {
        ...
        pro: {
          title: "🎟 Distribution rights with discounts up to 30%",
          items: [
