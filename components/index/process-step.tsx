      ...
      <div
        className={`${
          active
            ...
            : "gap-1 self-center px-1 w-10 h-10 text-lg font-medium whitespace-nowrap bg-white border border-gray-200 border-solid min-h-10 rounded-[100px] text-zinc-800"
        }`}
      >
        {active ? (
          <img
