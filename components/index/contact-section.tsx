  ...
  return (
    <SectionContainer bgColor="bg-slate-50">
      <div className="flex flex-wrap gap-10 justify-center items-start max-w-screen-md w-[768px] max-md:max-w-full">
        <div className="flex flex-col flex-1 shrink justify-center text-base basis-8 min-w-60 text-zinc-800 max-md:max-w-full">
          <h2 className="self-start text-4xl font-medium text-center">
            Liên hệ
          </h2>
          <p className="mt-5 font-semibold max-md:max-w-full">
            Có câu hỏi nào không?
          </p>
          <p className="mt-5 leading-6 text-gray-700 max-md:max-w-full">
