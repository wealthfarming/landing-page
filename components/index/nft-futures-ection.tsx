  ...
  return (
    <SectionContainer>
      ...
      <div className="flex flex-col items-center mt-20 max-w-full max-md:mt-10 max-md:justify-center w-full">
        <div className="relative overflow-hidden w-full bg-white rounded-md max-w-[234px] h-[84px]">
          <div className="absolute inset-0 bg-gradient-to-r from-[#FDF0BA] to-[#CDFEE4] p-[1px] rounded-md">
            <div className="bg-white h-full rounded-md">
              <div className="gap-1 self-stretch px-1 py-2 w-full text-lg font-medium border-b font-geist-raleway border-gray-200 min-h-[39px] text-[var(--primary)] text-center">
                {t('profit')}
              </div>
              <div className="flex items-center w-full text-white text-center h-10 bg-green-500">
                <div className="flex-1 shrink gap-1 self-stretch my-auto w-full basis-0 text-2xl font-geist-mono font-bold">
                  $100k → $394k
                </div>
              </div>
            </div>
        ...
        <p className="mt-4 text-xs">{t('nft_future_section_profit_duration')}</p>
      </div>
    </SectionContainer>
  );
};
