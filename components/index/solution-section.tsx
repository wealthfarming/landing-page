    ...
    <SectionContainer>
      ...
      <div className="flex flex-wrap gap-10 justify-center items-start mt-20 w-full max-md:mt-10 max-md:max-w-full">
        <div className="flex-1 shrink p-2 text-base bg-white rounded-xl border border-gray-200 border-solid basis-0 min-w-60 text-zinc-800 max-md:max-w-full">
          <div className="flex flex-wrap w-full text-lg font-semibold text-orange-300 border-b border-gray-200 max-md:max-w-full">
            <div className="flex-1 shrink gap-1 p-4 h-full basis-0 min-w-60">
              Tính năng
            </div>
            <div className="flex-1 shrink gap-1 p-4 h-full basis-0 min-w-60">
              Lợi ích
          ...
          <div className="flex flex-wrap w-full max-md:max-w-full">
            <div className="flex-1 shrink gap-1 p-4 h-full font-semibold basis-0 min-w-60">
              Dự Đoán Chỉ Số AI
            </div>
            <div className="flex-1 shrink gap-1 p-4 h-full leading-6 basis-0 min-w-60">
              Độ chính xác 89.2% từ 74 sự kiện bổ sung cổ phiếu (2022-2025).
            </div>
          </div>
          <div className="flex flex-wrap w-full rounded-lg bg-slate-50 min-h-28 max-md:max-w-full">
            <div className="flex-1 shrink gap-1 p-4 h-full font-semibold basis-0 min-w-60">
              NFT Quỹ
            </div>
            <div className="flex-1 shrink gap-1 p-4 h-full leading-6 basis-0 min-w-60">
          ...
          <div className="flex flex-wrap w-full min-h-[108px] max-md:max-w-full">
            <div className="flex-1 shrink gap-1 p-4 h-full font-semibold basis-0 min-w-60">
              DeFi Integration
            </div>
            <div className="flex-1 shrink gap-1 p-4 h-full leading-6 basis-0 min-w-60">
          ...
          <div className="flex flex-wrap w-full rounded-lg bg-slate-50 min-h-[107px] max-md:max-w-full">
            <div className="flex-1 shrink gap-1 p-4 h-full font-semibold basis-0 min-w-60">
              Cơ Chế Rủi Ro
            </div>
            <div className="flex-1 shrink gap-1 p-4 h-full leading-6 basis-0 min-w-60">
        ...
        <div className="flex-1 shrink basis-4 min-w-60 max-md:max-w-full">
          <div className="flex relative flex-col justify-center items-center px-16 py-28 w-full rounded-2xl min-h-[295px] max-md:px-5 max-md:py-24 max-md:max-w-full">
            <img
            ...
            />
            <div className="flex relative gap-1 justify-center items-center px-1 -mb-6 bg-white bg-opacity-60 h-[60px] min-h-[60px] rounded-[100px] w-[60px] max-md:mb-2.5">
              <img
