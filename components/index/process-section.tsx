...
const ProcessSection: React.FC = () => {
  return (
    <SectionContainer>
      ...
      />
      <div className="flex relative gap-4 items-center mt-10 w-full max-md:max-w-full">
        <div className="absolute top-5 z-0 shrink-0 self-start h-0 border border-gray-200 border-solid inset-x-[134px] min-w-60 w-[852px]" />
