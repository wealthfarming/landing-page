...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    orange: "!border-[1px] !rounded-[4px] cursor-pointer !shadow-[0px_1px_2px_0px_rgba(0,0,0,0.24)] !py-0 !px-[24px] !bg-[var(--color-primary)] hover:brightness-[1.1] border-none button rounded-none transition-transform duration-300 ease-in-out text-zinc-800",
  };
