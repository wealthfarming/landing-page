...
interface VideoGuildPageProps {
    modalActive: boolean;
    setModalActive: (active: boolean) => void;
}

const VideoGuildPage: React.FC<VideoGuildPageProps> = () => {
    ...
    return (
        <div className='w-full h-full bg-white shadow-lg rounded-lg relative z-50'>
            ...
            {/* <span className="flex flex-row items-center justify-between mb-4 relative w-full ">
                ...
                <h2 className="text-xl font-bold text-center w-full">{t('guild_video')}</h2>
            </span> */}
