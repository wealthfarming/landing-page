...
export default function HomeSection1() {
    ...
    return (
        <div className="w-full flex-grow flex flex-col items-center justify-start bg-background lg:mt-80 lg:pt-14 mt-18 sm:mt-18 md:mt-0 sm:py-18 md:py-18 relative z-30">
            ...
            <h1 className="lg:text-7xl md:text-5xl text-4xl font-normal mb-4 w-full md:w-9/12 text-center py-2 max-w-[1100px] font-geist-display ">{t('home_section_1_title')}</h1>
